...
function categories_data_to_schema_production_data_to_update(data, get_production_data,production_date, datetime) {        
    return new Promise(async(resolve, reject) => {
        try {
...
function generateId(connection, data, seq_type) {
    return new Promise(async(resolve, reject) => {
        ...
        try{
            employee_detail = await productionDao.fetchEmployeeId(connection,data.branch_id, seq_type);

            ...
            try {
                ...
                if(data.hasOwnProperty('product_id')) {
                    ...
                    if(get_product_data.hasOwnProperty('status')) {
                        ...
                        var set_product_pricing_data = await categories_data_to_schema_product_price_data_to_default_create(read_connection,data, product_data, eod_date, date);
                ...
                read_connection = await productDao.getReadConnection();
                       ...
                       if(check_product_existing_record==0){
                        ...
                        if(check_product_pricing_count == 0) {                           
                            var set_product_pricing_data = await categories_data_to_schema_product_price_data_to_create(read_connection, data, data, new_from_date, date);
                            var insert_product_pricing_data = await productDao.createProductPricing(read_connection, set_product_pricing_data);
                            ...
                            var set_update_product_pricing_data = await categories_data_to_schema_product_price_data_to_update(read_connection, data, data, old_previous_date, date, get_product_pricing_data);
...
function categories_data_to_schema_product_price_data_to_default_create(read_connection, data,product_data, eff_from, date) {
    return new Promise(async(resolve, reject) => {
        try {
            var normal_data = {
                org_id: data.org_id,
